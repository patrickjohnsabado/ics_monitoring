  ...
  <div class="wrapper">
            ...
            <section class="content">
                <div class="col-md-3" style="width: 100%;">
                    ...
                    <div class="box box-default collapsed-box">
                      <div class="box-header with-border">
                        <h3 class="box-title">Export Logs to Excel</h3>
                      ...
                      <div class="box-footer">
                          <form autocomplete="off" action="/logs/excel" method="POST">
                            ...
                            <span class="input-group-btn">
                                ...
                                <div class="classes">
                                  ...
                                  <div class="input-group date" style="width: 100%;">
                                    ...
                                    <input type="text" class="form-control pull-right" name="date" id="datepicker" required>
                                    
                                  </div>
                                  <input type="submit" class="btn btn-block btn-primary" style="width: 100%" value="Export">
                        ...
                        <div class="buttons">
                              <div class="button1">
                                <button style="background-color: green; border-color: green; width: 100%;" class="btn btn-block btn-primary"  onClick="window.open('/logs/excel/all');">Export All Logs</button>
                              </div>
                        </div>
                      </div>
                      <!-- /.box-footer-->
              ...
              <div class="row">
                <div class="col-xs-12">
                  ...
                  <form id="formDelete" action="/deleteLogs" method="POST">
                    {{ csrf_field() }}
                  </form>
                  <div class="box">

                    <div class="box-header">
                      <form action="/logs/create">
                        <button class="btn btn-primary" style="width: 10%"><i class="zmdi zmdi-plus"></i>Add Logs</button>
    ...
    border-color: #d73925;" value="Delete Selected Record">
                            ...
                            <div class="modal-dialog">
                              <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                  ...
                                  <input form="formDelete" type="submit"  class="btn btn-outline" style="background-color: #dd4b39; border-color: #d73925;" value="Delete">
                                </div>
                              </div>
                              <!-- /.modal-content -->
                            </div>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                          ...
                          <tr>
                            <th>
                                <input form="formDelete" type="checkbox" onclick="toggle(this);">
                                Select All
                            </th>
                            <th>#</th>
                            <th>Name</th>
                          ...
                          <tbody>
                            @foreach ($logs as $log)
                            <tr>
                              <td style="text-align: center;"> <input type="checkbox" form="formDelete" name="delete[]" value="{{ $log->log_id }}"> </td>
                            ...
                            @endforeach  
                              ...
                              <td style="text-align: center;">{{$log->semester}} || {{$log->start}} to {{$log->end}}</td>
                              <style type="text/css">
