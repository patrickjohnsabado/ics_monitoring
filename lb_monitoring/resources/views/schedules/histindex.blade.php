              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="box box-primary">
                    <form id="formDelete" action="/deleteSchedules" method="POST">
                      ...
                      <div class="modal fade" id="modal-default-archive">
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
                              <input form="formDelete" type="submit"  class="btn btn-outline" style="background-color: #00c75a; border-color: #00c75a;" name="action" value="Archive">
                            </div>
                          </div>
                          <!-- /.modal-content -->
                        </div>
                    ...
                    <div class="box-body">
                      ...
                      <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                          ...
                          <tr>
                          <td style="text-align: center;"> <input form="formDelete" type="checkbox" name="delete[]" value="{{ $schedule->id }}"> </td>
                          ...
                          @endforeach
                          @foreach ($schedules_hist as $schedule)
                          <tr>
