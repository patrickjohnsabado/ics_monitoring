...
<head>
  ...
  <title>Lab Monitoring | Subjects  </title>
              ...
              <div class="row">
                <div class="col-md-3" >
                  <div class="box box-solid" >
                    ...
                    <div class="box-body">
                      <form action="/subjects" autocomplete="off" method="POST" autocomplete="off">
                        @csrf
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              <div class="modal-header" style=" border-bottom: 1px solid;">
                                ...
                                <h4 class="modal-title">Delete Selected Subject</h4>
                              </div>
                              <div class="modal-body">
                                <p style="display: flex; justify-content: center; font-size: 20px">Are you sure want to delete the selected Subject/s?</p>
                              </div>
                    ...
                    <div class="box-body">
                      ...
                      <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                          ...
                          <tr>
                          <td style="text-align: center;"> <input type="checkbox" name="delete[]" value="{{ $subject->id }}"> </td>
                            <td style="text-align: center;">{{$subject->course_number}}</td>
                            <td style="text-align: center;">{{$subject->description}}</td>
