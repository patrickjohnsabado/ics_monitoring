...
<head>
  ...
  <title>Lab Monitoring | Room</title>
                ...
                <div class="col-md-3" >
                  <div class="box box-solid" >
                    <div class="box-header with-border ">
                      <h3 class="box-title">Add Laboratory Room</h3>
                    </div>
                    <div class="box-body">
                      <form action="/room" autocomplete="off" method="POST">
                        @csrf
                    ...
                    <div class="box-body">
                      ...
                      <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                          ...
                          <tr>
                          <td style="text-align: center;"> <input type="checkbox" name="delete[]" value="{{ $room->id }}"> </td>
