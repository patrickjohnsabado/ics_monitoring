...
<head>
  ...
  <title>Lab Monitoring | Create New Faculty User</title>
      ...
      <div class="content-wrapper">
          ...
          <section class="content-header">
            ...
            <ol class="breadcrumb">
              ...
              <li class="active"><a href="/facultes">Faculty</a></li>
              <li class="active"><a href="/faculties/create">Add Faculty User</a></li>
            </ol>
          </section>
