...
<head>
  ...
  <title>Lab Monitoring | Faculty Profile</title>
            ...
            <div class="col-md-3">
              <div class="box box-primary">
                <div class="box-body box-profile">
                  ...
                  <h3 class="profile-username text-center">{{$faculties->fullname}}</h3>
                  <p class="text-muted text-center">{{$faculties->id_number}}</p>
                <p class="text-muted text-center">{{$faculties->email}}</p>
                </div>
              </div>
              ...
              <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="settings">
                        {!! Form::open(['action' => ['FacultyController@update', $faculties->id_number], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
