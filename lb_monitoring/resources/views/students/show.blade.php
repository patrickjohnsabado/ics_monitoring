...
<head>
  ...
  <title>Lab Monitoring | Student Profile</title>
              ...
              <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                  <div class="active tab-pane" id="activity">
                    ...
                    <div class="post clearfix">
                      <div class="user-block">
                        ...
                        <span class="description">Date: {{$log->date_login}} {{$log->time_from}} - {{$log->time_to}}</span>
                    ...
                    @else
                    <span class="username">
                            <a href="#">There are recorded logs for this student</a>
                  ...
                  <div  class="active tab-pane" id="settings">
                        {!! Form::open(['action' => ['StudentController@update', $students->id_number], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
