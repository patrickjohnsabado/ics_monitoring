                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              <div class="modal-header" style=" border-bottom: 1px solid;">
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                  <span aria-hidden="true">&times;</span></button>
                                <h4 class="modal-title">Restore Selected Student</h4>
                              </div>
                              <div class="modal-body">
                                <p style="display: flex; justify-content: center; font-size: 20px">Are you sure want to Restore the Student Records?</p>
                                <label>With Logs: </label>
                              <label>
                                <input form="formDelete" type="checkbox" name="log" value="1">
                              </label><br>
                              <label>With Printed records: </label>
                              <label>
                                <input form="formDelete" type="checkbox" name="print" value="1">
                              </label>
                              </div>
